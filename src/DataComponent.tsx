...
const DataComponent: React.FC<DataProps> = ({ data }) => {
  ...
  return (
    <div className='data' style={{ display: 'flex',flexDirection: 'column' , maxHeight: '1000px' }} >
        ...
        <Graph data={specifiData}  width={300} height={100} color='Lime' title='График скорости'  bottomTitle='Измерения в км/час'/>
        <Graph data={specifiData}  width={80} height={70} color='SpringGreen' title='График температуры' bottomTitle='Измерение в Цельсий' />
    </div> 
  )
}
